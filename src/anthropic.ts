...
// import { writeExperimentJson } from "./lib/writeSession.js";
...
//         {
//           type: "text",
//           text: "And here's an image of the target grid. It has exactly one cell set to red.",
//         },
//         {
//           type: "image",
//           source: {
...
//     description:
//       "Input is a solid grid with a single red cell on it, output should be the same grid.",
//     parameters: {
//       model: MODEL,
